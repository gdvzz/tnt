...
1. **下载样例压缩包**：[江大云盘↗](https://pan.jiangnan.edu.cn/link/AA23E65DBB8FEF4226AA5CBBDF8BEF438C)
...
- [face_detect.py](./aidk260612.assets/face_detect.py)
- [predictor.py](./aidk260612.assets/predictor.py)
...
10、开发板可能有几个摄像头。要使用额外连接的USB摄像头
11、注册人脸时增加用摄像头拍照注册。也保留选择照片注册。
12、web界面上显示已经注册的人脸照片和姓名。
13、识别的相似度阈值初始值为0.5
14、web界面增加删除注册的人脸
``` -->
...
![oss01](./aidk260612.assets/webapp.jpg)

<details markdown="block">
  <summary>webapp.py样例代码</summary>

- [webapp.py](./aidk260612.assets/webapp.jpg)
</details>
...
- [test_tts.py](./aidk260612.assets/test_tts.py)：测试声音。
...
[MobaXterm简要指南↗]: https://tnt.gdvzz.com/aikit/mobaxtermug.html
