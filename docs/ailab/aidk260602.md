...
- ✳️ **个人电脑是否有网口**。在 PC（个人电脑）按 `win` + `i` 调出 <ins>设置</ins>，点击左侧导航栏 <ins>网络和Internet</ins> → 点击右下的 <ins>高级网络设置</ins> → 在右侧顶部 <ins>网络适配器</ins> 能看到 <ins>以太网</ins> 或 <ins>Ethernet</ins>，则大概率有网口。如果没有网口，可再借用“USB转网口”适配器。
...
<img src="./aidk260602.assets/111_yangmi.jpeg" alt="111_yangmi" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/112_zhanglinghe.jpeg" alt="112_zhanglinghe" style=" width: auto; height: 8rem; max-width:100%;">
</details>
<!--  -->
<details markdown="block">
  <summary>用做识别的图片</summary>
<img src="./aidk260602.assets/ym1.jpg" alt="ym1" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/ym2.jpg" alt="ym2" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/ym3.jpeg" alt="ym3" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/ym4gp.jpeg" alt="ym4gp" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/zlh1.jpg" alt="zlh1" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/zlh2.jpg" alt="zlh2" style=" width: auto; height: 8rem; max-width:100;">
<img src="./aidk260602.assets/zlh3.jpeg" alt="zlh3" style=" width: auto; height: 8rem; max-width:100;">
</details>
<!--  -->
<!--  -->
<details markdown="block">
...
- **参考界面1：**
    ...
    <img src="./aidk260602.assets/ss01.jpg" alt="ss01" style=" width: auto; height: 16rem; max-width:100;">

- **参考界面2：**

    <img src="./aidk260602.assets/ss02.jpg" alt="ss02" style=" width: auto; height: 16rem; max-width:100;">
...
- **调测窗口组合：**
    ...
    <img src="./aidk260602.assets/ss03.jpg" alt="ss03" style=" width: auto; height: 16rem; max-width:100;">

<details markdown="block">
  <summary>参考代码</summary>
[webapp.py](./aidk260602.assets/webapp.py)
