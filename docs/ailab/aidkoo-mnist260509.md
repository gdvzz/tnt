...
2. **在开发板上新建实验用目录：**
    ...
    该实验目录的完整路径是：/home/HwHiAiUser/mnist0509
...
4. **训练模型**
    ...
    ✳️ 开发板主要用于推理（用程序调用训练好的模型），不用做模型训练。
...
3. **本地电脑浏览器访问开发板**
    ...
    - <img src="https://tnt.gdvzz.com/aikit/aidk.assets/ascend-logo.svg" alt="ascend-log" style=" width: auto; height: 1.2rem; max-width: 100%;"> 昇腾：`192.168.137.100:5000` 
    - <img src="https://tnt.gdvzz.com/aikit/dkoo.assets/kunpeng-logo.svg" alt="kunpeng-log" style=" width: auto; height: 1.2rem; max-width: 100%;"> 鲲鹏：`192.168.137.200:5000` 
...
1. **关机断电**
    ...
    - <img src="https://tnt.gdvzz.com/aikit/dkoo.assets/kunpeng-logo.svg" alt="kunpeng-log" style=" width: auto; height: 1.2rem; max-width: 100%;"> **鲲鹏开**:[关机断电↗](https://tnt.gdvzz.com/aikit/dkoo.html#onoff) 
