...
4. **在虚拟环境中安装相关包：**
    ...
    ``` -->
    <!-- ```bash
    pip3 install numpy==1.24.0 flask opencv-python onnxscript onnx
    ``` -->
...
4. **在开发板上解压缩**
    ...
    解压缩后生成子目录 mnist-master，完整路径应该是：/home/HwHiAiUser/mnist0509/mnist-master。
