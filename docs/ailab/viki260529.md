...
1. **Put cubes like:**
    ...
    ![irobot6](https://tnt.gdvzz.com/aikit/irobots.assets/irobot6.jpg)
...
5. **Grab and move yellow cube:**
    ...
    ```bash
new task, grab yellow cube and move to 80,200
    ```

Cubes moves to specific position like:

![iroobot4](https://tnt.gdvzz.com/aikit/irobots.assets/irobot4.jpg)
...
![iroobot5](https://tnt.gdvzz.com/aikit/irobots.assets/irobot5.jpg)
