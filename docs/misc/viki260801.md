...
以 `grab red cube and move to 80,220,110` 为例：

- 抓取红色方块
- 并移动到 x = 80，y = 220，z = 110 的位置
...
机械臂有时抓得不是很准。可通过修改 `~/t181/config.json`（如下所示） 的 x y z 的偏移值，让机械臂抓得准确些。
